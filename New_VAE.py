...
Density_train = 1-np.load(path / ('Density_Train.npy'), allow_pickle=True)
Density_test  = 1-np.load(path / ('Density_Test.npy'), allow_pickle=True)
...
Appr_Rho       = 1-np.load(path / ('Linear_to_Nonlinear_Density.npy'), allow_pickle=True)
